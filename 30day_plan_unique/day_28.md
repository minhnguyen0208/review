...
### English (Interview)
- **Self-intro (30–45s)**: *Hi, I'm Minh… Today I focused on interview prep day 28 with an emphasis on reliability and performance.*
...
- BE deep-dive: Queue+Retry+DLQ, Testing(Feature), Txn+Outbox.
...
### Practice Tasks
- Implement: **Interview Prep Day 28** feature end-to-end (BE & FE), commit with README explaining design choices.
