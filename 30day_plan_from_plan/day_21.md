...
class CreateOrderHandler { public function handle(CreateOrderCommand $cmd){ return DB::transaction(function() use($cmd){ $o=Order::create($cmd->data); event(new OrderCreated($o->id,$o->total)); return $o; }); } }
```
...
### English (Interview)
- **Pitch (30–45s)**: *Hi, I'm Minh, a Laravel + React engineer. Today I focused on cqrs.*
